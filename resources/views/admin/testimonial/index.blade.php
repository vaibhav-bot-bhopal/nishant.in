            ...
            <div class="col-lg-8 col-md-8 offset-lg-2 offset-md-2">
                ...
                <form action="{{ route('addTestimonial') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('n_name') is-invalid @enderror" id="n_name" name="n_name" value="{{old('n_name')}}" placeholder="Enter Name Here">
                        @error('n_name')
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="ckeditor form-control @error('n_disc') is-invalid @enderror" rows="5" id="n_disc" name="n_disc" placeholder="Enter Description Here">{{old('n_disc')}}</textarea>
                        @error('n_disc')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
